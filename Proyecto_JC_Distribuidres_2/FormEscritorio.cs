...
namespace Proyecto_JC_Distribuidres_2
{
    public partial class FormEscritorio : Form
    {
        ...
        #endregion
        //abrir forularios dentro de panel 
        private void AbrirFormulario<MiForm>() where MiForm : Form, new()
        {
            Form formulario;
            formulario = panelFormularios.Controls.OfType<MiForm>().FirstOrDefault(); //busca la conexion en e formulario
            if (formulario == null)
            {
                formulario = new MiForm();
                formulario.TopLevel = false;
                formulario.FormBorderStyle = FormBorderStyle.None;//quitar borde a formulario
                formulario.Dock = DockStyle.Fill;//acoplacion al panel
        ...
        private void CloseForms(object sender,FormClosedEventArgs e)
        {
            if (Application.OpenForms["Form2"] == null)
                button1.BackColor = Color.FromArgb(4, 61, 68);
            if (Application.OpenForms["Form3"] == null)
                button2.BackColor = Color.FromArgb(4, 61, 68);
            if (Application.OpenForms["Form4"] == null)
                button3.BackColor = Color.FromArgb(4, 61, 68);
            if (Application.OpenForms["Form5"] == null)
                button4.BackColor = Color.FromArgb(4, 61, 68);
        }
    }
}
